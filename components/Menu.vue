<template>
    <div class="h-full max-w-24 w-full">
        <div class="flex items-center h-full w-full py-5 bg-slate-950">
            <ul class="list-none text-white w-full">
                <li :class="routePath == '/dashboard' ? 'active' : ''" class="menu-item py-4 px-4 cursor-pointer">
                ...
                <li :class="routePath == '/top-artists' ? 'active' : ''" class="menu-item py-4 px-4 cursor-pointer">
                ...
                <li :class="routePath == '/top-tracks' ? 'active' : ''" class="menu-item py-4 px-4 cursor-pointer">
                ...
                <li :class="routePath == '/recent' ? 'active' : ''" class="menu-item py-4 px-4 cursor-pointer">
                    <NuxtLink to="/recent"> 
                        <span class="block w-6 h-6 mx-auto mb-2 fill-white">
                ...
                <li :class="routePath == '/playlists' ? 'active' : ''" class="menu-item py-4 px-4 cursor-pointer">
...
<style lang="scss" scoped>
    .menu-item.active {
        @apply bg-slate-800 border-l-slate-800;
    }
    .menu-item {
        @apply border-l-8 border-l-slate-950 transition-colors duration-200;
        &:hover {
