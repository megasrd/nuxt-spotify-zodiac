<template>
    <div class="fixed top-0 left-0 h-full max-w-24 w-full">
        <div class="flex items-center h-full w-full py-5 bg-slate-950">
            <ul class="list-none text-white w-full">
                <li class="menu-item active py-4 px-4 cursor-pointer">
                ...
                <li class="menu-item py-4 px-4 cursor-pointer">
                    ...
                    <label class="block text-center text-xs"> Playlists </label>
                </li>
            </ul>
        </div>
    </div>
