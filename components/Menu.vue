<template>
    <div class="md:h-full md:max-w-24 w-full">
        <div class="md:flex md:items-center md:h-full w-full md:py-5 bg-slate-950">
            <ul class="md:block grid grid-cols-5 list-none text-white w-full">
                <li :class="routePath == '/dashboard' ? 'active' : ''" class="menu-item py-4 md:w-full  md:px-4 px-1 cursor-pointer">
                ...
                <li :class="routePath == '/top-artists' ? 'active' : ''" class="menu-item py-4 md:w-full  md:px-4 px-1 cursor-pointer">
                ...
                <li :class="routePath == '/top-tracks' ? 'active' : ''" class="menu-item py-4 md:w-full  md:px-4 px-1 cursor-pointer">
                ...
                <li :class="routePath == '/recent' ? 'active' : ''" class="menu-item py-4 md:w-full  md:px-4 px-1 cursor-pointer">
                    <NuxtLink to="/recent"> 
                        <span class="block w-6 h-6 mx-auto mb-2 fill-white">
                ...
                <li :class="routePath == '/playlists' ? 'active' : ''" class="menu-item py-4 md:w-full  md:px-4 px-1 cursor-pointer">
...
<style lang="scss" scoped>
    .menu-item.active {
        @apply bg-slate-800 md:border-l-slate-800;
    }
    .menu-item {
        @apply md:border-l-8 md:border-l-slate-950 transition-colors duration-200;
        &:hover {
